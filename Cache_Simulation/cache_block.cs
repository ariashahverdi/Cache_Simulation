...
namespace Cache_Simulation
{
    public partial class cache_block : Form
    {
        public cache_block(cache my_cache, int row, int col)
        {
            ...
            textBox7.Text = (payload.Substring(32, 16));
            textBox6.Text = (payload.Substring(48, 16));

            textBox9.Text = (payload.Substring(64, 16));
            textBox8.Text = (payload.Substring(80, 16));
            textBox11.Text = (payload.Substring(96, 16));
